export default function Header() {
  ...
  return (
    <header className="bg-neutral-dark shadow-md sticky top-0 z-[1000]">
      <div className="border-b border-neutral/30 py-6">
        <div className="container">
          <div className="flex justify-between items-center">
            <div className="logo flex items-center gap-3">
              <img src="/logo.png" alt="Portal Tubaínas Logo" className="h-16 md:h-20 w-auto" />
            </div>
            <div className="flex gap-6 items-center">
              ...
              <a href="#anuncie" className="px-4 py-2 md:px-5 md:py-2.5 bg-gradient-to-br from-accent to-accent-dark text-white rounded-full font-semibold text-xs md:text-sm transition-all duration-300 shadow-lg shadow-accent/30 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-accent/40 hover:from-accent-light hover:to-accent">
                Para Anunciantes
              </a>
              <a href="#busca" className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 text-neutral-light transition-all duration-200 hover:bg-primary hover:text-white" aria-label="Buscar">
      ...
      <div className="p-0 bg-neutral-dark/95">
        <div className="container">
          <nav className="flex gap-0 overflow-x-auto [-webkit-overflow-scrolling:touch] scrollbar-none [&::-webkit-scrollbar]:hidden">
